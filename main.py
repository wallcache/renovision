...
def build_renovation_prompt(request: RenovationRequest) -> str:
    ...
    style_prompts = {
        ...
        'hals_choice': 'Transform this room into a warm contemporary English home interior. Natural oak and walnut wood tones throughout, including vertical wood wall panelling. Sage green and forest green accents. Cream and off-white walls where not panelled. Herringbone hardwood floors. Built-in floor-to-ceiling bookshelves. Abundant natural light through windows (no skylights). Warm ambient lighting with brass and aged bronze fixtures. Layered, lived-in feel with curated art and plants. No stark whites, no grey tones, no overtly minimalist aesthetic. Architectural details preserved. Photography style: editorial interiors, soft natural light, shot on medium format. KITCHEN SPECIFIC: If this is a kitchen, apply the following: Warm contemporary kitchen with natural oak or walnut cabinetry, no painted cabinets. Vertical sage green or teal subway tile backsplash. White marble or light stone countertops with warm veining. Vertical wood wall panelling on feature wall. Smoked oak herringbone flooring. Open wooden shelving with ceramics and cookbooks. Brass or bronze hardware and fixtures. Integrated appliances. A single statement pendant light. Warm, inviting, contemporary but timeless. BATHROOM SPECIFIC: If this is a bathroom, apply the following: Warm contemporary bathroom with floor-to-ceiling green zellige or textured tile in sage or forest tones. Natural oak vanity with white stone countertop. Vertical wood panelling on one wall. Large format mirror with brass or bronze frame. Wall-mounted brass fixtures. Herringbone marble or stone flooring in warm cream tones. Built-in alcove shelving. Soft towels, single plant. Spa-like but warm, not clinical. No skylights. LIVING ROOM SPECIFIC: If this is a living room, apply the following: Warm contemporary living room with vertical oak wood wall panelling. Deep green or warm cream painted walls on remaining surfaces. Built-in floor-to-ceiling bookshelves flanking doorway or fireplace. Herringbone oak flooring. Warm beige-grey Togo sofa as centrepiece, low and sculptural. Layered brass and ceramic table lamps. Gallery wall with eclectic framed art including Keith Haring pieces. Warm afternoon light. Brass curtain rods with linen curtains. Books stacked on coffee table. Cultivated, literary, inviting. No skylights. DINING ROOM SPECIFIC: If this is a dining room, apply the following: Warm contemporary dining room with vertical oak wood wall panelling. Solid oak or walnut dining table with natural grain, rectangular, seats 6-8. Cesca chairs in natural cane and chrome surrounding the table. Built-in sideboard or credenza in matching wood tones. Statement pendant light in brass or woven material above table. Gallery wall featuring Keith Haring prints alongside photography and eclectic art. Herringbone oak flooring. Warm cream or sage painted walls where not panelled. Brass candlesticks on table. Large ceramic vase with branches or greenery. Soft linen curtains. Editorial, collected, convivial. No skylights.',
    }
