...
def build_renovation_prompt(request: RenovationRequest) -> str:
    ...
    style_prompts = {
        'modern_organic': 'A magazine-quality modern organic interior with warm neutral tones, sculptural forms with rounded edges, raw linen textures, plaster walls with subtle texture, handmade ceramic vases, woven natural materials, indoor plants, neutral color palette of cream, camel, sand and pale taupe, organic curved lines, cozy but refined atmosphere, styled like a Homes & Gardens editorial shoot, high detail, ultra-realistic photography, Canon EOS R5, 35mm lens, soft depth of field',

        'scandinavian_minimalism': 'A Scandinavian minimalist space with whitewashed walls, simple low-profile forms, soft wool throws, clean lines in light grey tones, pale wooden elements, matte black accents, subtle greenery, uncluttered surfaces, hygge atmosphere, serene and airy, tastefully styled like a Nordic design magazine editorial, ultra-realistic photography, balanced composition, soft textures',

        'japandi': 'A Japandi-style area combining Japanese and Scandinavian aesthetics, neutral earth tones, tatami-inspired textures, low wooden forms, linen textures, minimalist decor, ceramic vessels, textured plaster walls, boucle textures, large indoor plants, zen atmosphere, uncluttered space, refined and tranquil ambiance, styled for an interior design magazine shoot, ultra-realistic photography',

        'parisian_classic': 'A Parisian-style classic interior with ornate ceiling moldings, bright white walls, contemporary neutral tones, velvet textures, brass lighting fixtures, vintage mirrors, elegant layering of classic and modern elements, refined but lived-in mood, styled like a Homes & Gardens Paris apartment feature, ultra-realistic editorial photography',

        'coastal_elevated': 'An elevated coastal interior with soft blues, sandy neutrals and crisp whites, light oak elements, linen slipcovered textures, woven rattan materials, textured throw pillows, driftwood accents, seagrass materials, no kitsch or nautical props, refined beach-house elegance, tasteful decor styled for a high-end coastal interiors magazine shoot, ultra-realistic photography',

        'midcentury_modern': 'A mid-century modern interior with walnut elements, tapered wooden legs, leather upholstery, geometric patterned materials, sunburst accents, statement arc lighting, low-profile forms, large abstract wall art, rich warm tones, indoor plants, balanced composition, styled like a design magazine editorial, ultra-realistic photography',

        'moody_contemporary': 'A moody contemporary interior with deep charcoal walls, bronze and matte black accents, plush velvet textures, sculptural lighting fixtures, large abstract artwork, layered textures, dramatic soft lighting, warm contrast highlights, modern luxury atmosphere, upscale styling for an architectural digest editorial shoot, ultra-realistic photography',

        'rustic_modern': 'A rustic-modern interior with large linen forms, reclaimed wood elements, neutral layered textiles, wool materials, modern lighting fixtures, earthy tones, natural wood pieces, relaxed sophistication, styled for a premium countryside interiors magazine shoot, ultra-realistic photography',

        'english_contemporary': 'An English contemporary interior with classic paneled walls, layered textiles, soft neutral color palette, upholstered forms with tailored lines, patterned accent cushions, antique elements mixed with modern lighting, framed botanical prints, bookshelves with curated styling, refined warmth, styled as a Homes & Gardens British interior editorial, ultra-realistic photography',
    }
