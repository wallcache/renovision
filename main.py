...
def build_renovation_prompt(request: RenovationRequest) -> str:
    ...
    style_prompts = {
        ...
        'hals_choice': 'Transform this room into a warm contemporary English home interior with mid-century influences. Natural oak and walnut wood tones throughout, including vertical wood wall panelling. Sage green and forest green accents. Cream and off-white walls where not panelled. Vintage Persian rugs on herringbone hardwood floors. Built-in floor-to-ceiling bookshelves. Abundant natural light from skylights. Warm ambient lighting with brass and aged bronze fixtures. Layered, lived-in feel with curated art and plants. No stark whites, no grey tones, no overtly minimalist aesthetic. Architectural details preserved. Photography style: editorial interiors, soft natural light, shot on medium format. KITCHEN SPECIFIC: If this is a kitchen, apply the following: Warm contemporary kitchen with natural oak or walnut cabinetry, no painted cabinets. Vertical sage green or teal subway tile backsplash. White marble or light stone countertops with warm veining. Vertical wood wall panelling on feature wall. Large skylight flooding space with natural light. Smoked oak herringbone flooring. Open wooden shelving with ceramics and cookbooks. Brass or bronze hardware and fixtures. Integrated appliances. A single statement pendant light. Persian runner rug. Warm, inviting, mid-century influenced but not retro. BATHROOM SPECIFIC: If this is a bathroom, apply the following: Warm contemporary bathroom with floor-to-ceiling green zellige or textured tile in sage or forest tones. Natural oak vanity with white stone countertop. Vertical wood panelling on one wall. Large format mirror with brass or bronze frame. Wall-mounted brass fixtures. Skylight or frosted window for natural light. Herringbone marble or stone flooring in warm grey or cream tones. Built-in alcove shelving. Soft towels, single plant. Spa-like but warm, not clinical. LIVING ROOM SPECIFIC: If this is a living room, apply the following: Warm contemporary living room with vertical oak wood wall panelling. Deep green or warm cream painted walls on remaining surfaces. Built-in floor-to-ceiling bookshelves flanking doorway or fireplace. Large vintage Persian rug over herringbone oak flooring. Low-profile sofa in warm brown leather or olive velvet. Layered brass and ceramic table lamps. Gallery wall with eclectic framed art and photography. Skylight or large sash windows. Warm afternoon light. Brass curtain rods with linen curtains. Books stacked on coffee table. Cultivated, literary, inviting.',
    }
